...
{  
	...
	GPIO_PinRemapConfig(GPIO_PartialRemap_TIM3, DISABLE); //Timer3部分重映射  TIM3_CH2->PB5    
...
{  
	...
	//GPIO_PinRemapConfig(GPIO_PartialRemap_TIM4, DISABLE); //Timer3部分重映射  TIM3_CH2->PB5    
...
{  
	...
	//GPIO_PinRemapConfig(GPIO_PartialRemap_TIM2, DISABLE); //Timer3部分重映射  TIM3_CH2->PB5    
